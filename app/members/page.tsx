...
async function getMemberData(userId: string): Promise<Member> {
  return {
    ...
    address: "Chicago, IL",
    // Profile fields - populated from Settings page in production
    avatarUrl: undefined,
    bio: "Software engineer passionate about Rajasthani heritage and community. Born in Jaipur, now calling Chicago home.",
    family: "Married to Sunita (dentist). Two children - Kavya (10) and Arjun (7). Originally from Jaipur, Rajasthan.",
  };
}
